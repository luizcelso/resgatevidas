...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var app\models\search\Animal $searchModel
*/
...
<div class="giiant-crud animal-index">
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class="pull-right">
            ...
            'encodeLabels' => false,
            'items' => [            [
                'url' => ['animal-type/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right">&nbsp;' . Yii::t('app', 'Animal Type') . '</i>',
            ],            [
                'url' => ['status/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right">&nbsp;' . Yii::t('app', 'Status') . '</i>',
            ],            [
                'url' => ['user/index'],
