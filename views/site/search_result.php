...
<div class="site-contact">
    ...
    <?= \yii\helpers\Html::a('Nova Pesquisa', \yii\helpers\Url::to(['search'], true)); ?>
...
<?php endforeach; ?>
<?php else: ?>
    <?php if (!empty($r)): //die(var_dump($r));?>
    
        <?php foreach ($model->models as $key => $model): ?>
            <?php if (in_array($key, $r)): ?>
    <div class="row">
    <div class="col-lg-4 col-md-4">
     <p><img src="<?= Yii::getAlias('@web') ?>/images/<?= $model->photo ?>" class="img-rounded"  width="304" height="236"></p>
    </div>
