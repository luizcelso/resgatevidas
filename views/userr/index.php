...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var app\models\search\Userr $searchModel
*/
...
<div class="giiant-crud userr-index">
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class="pull-right">
            ...
            'items' => [            [
                ...
                'url' => ['blog/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right">&nbsp;' . Yii::t('app', 'Blog') . '</i>',
            ],            [
                'url' => ['role/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right">&nbsp;' . Yii::t('app', 'Role') . '</i>',
            ],]
            ],
            'options' => [
            'class' => 'btn-default'
